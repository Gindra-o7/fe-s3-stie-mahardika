  ...
  return (
    <div className="relative">
      <motion.button
        ...
        className="flex items-center gap-2 px-3 py-2 rounded-lg border border-[#207D96] text-[#207D96] hover:bg-[#207D96] hover:text-white transition-all duration-200 group"
