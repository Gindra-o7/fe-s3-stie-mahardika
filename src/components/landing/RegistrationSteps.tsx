  ...
  const stepsData = [
    {
      ...
      points: ["Isi nama lengkap, email, nomor HP", "Buat username & password", "Verifikasi va email"],
      ...
      <div className="container mx-auto px-4 relative z-10">
        <motion.div className="text-center mb-16" initial={{ opacity: 0, y: -20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
          <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
            Tata Cara <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600">Pendaftaran</span>
          </h2>
        ...
        <motion.div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-16" initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
          <motion.button
            className="w-full sm:w-auto flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-xl hover:shadow-lg hover:shadow-purple-500/50 font-semibold transition-all"
          ...
          <motion.button
            className="w-full sm:w-auto flex items-center justify-center gap-2 bg-white border-2 border-gray-800 text-gray-800 px-8 py-4 rounded-xl hover:bg-gray-800 hover:text-white font-semibold transition-all"
            whileHover={{ scale: 1.05, y: -2 }}
            whileTap={{ scale: 0.95 }}
          >
        ...
        <motion.div className="text-center max-w-3xl mx-auto" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.2 }}>
          <div className="border-t-2 border-gray-200 pt-12">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-blue-50/50 p-8 rounded-2xl border border-gray-200">
