...
const translations = {
  id: {
    ...
    'curriculum.duration.normal': 'Durasi Normal',
    'curriculum.duration.max': 'Maksimal Studi',
  ...
  en: {
    ...
    'curriculum.duration.normal': 'Normal Duration',
    'curriculum.duration.max': 'Maximum Study',
  ...
  zh: {
    ...
    'curriculum.duration.normal': '正常学制',
    'curriculum.duration.max': '最长学制',
